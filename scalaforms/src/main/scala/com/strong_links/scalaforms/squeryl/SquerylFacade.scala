...
trait SquerylFacade extends PrimitiveTypeMode {
  ...
  implicit def stringFieldToTEF(f: Field[_, String])(implicit ev: String => TypedExpression[String, TString]) =
    f.internalValue: TypedExpression[String, TString]

  implicit def optionStringFieldToTEF(f: OptionalField[_, String])(implicit ev: Option[String] => TypedExpression[Option[String], TOptionString]) =
    f.internalValue: TypedExpression[Option[String], TOptionString]

  implicit def dateFieldToTEF(f: Field[_, Date])(implicit ev: Date => TypedExpression[Date, TDate]) =
    f.internalValue: TypedExpression[Date, TDate]

  implicit def optionDateFieldToTEF(f: OptionalField[_, Date])(implicit ev: Option[Date] => TypedExpression[Option[Date], TOptionDate]) =
    f.internalValue: TypedExpression[Option[Date], TOptionDate]

  implicit def timestampFieldToTEF(f: Field[_, Timestamp])(implicit ev: Timestamp => TypedExpression[Timestamp, TTimestamp]) =
    f.internalValue: TypedExpression[Timestamp, TTimestamp]

  implicit def optionTimestampFieldToTEF(f: OptionalField[_, Timestamp])(implicit ev: Option[Timestamp] => TypedExpression[Option[Timestamp], TOptionTimestamp]) =
    f.internalValue: TypedExpression[Option[Timestamp], TOptionTimestamp]

  implicit def booleanFieldToTEF(f: Field[_, Boolean])(implicit ev: Boolean => TypedExpression[Boolean, TBoolean]) =
    f.internalValue: TypedExpression[Boolean, TBoolean]

  implicit def optionBooleanFieldToTEF(f: OptionalField[_, Boolean])(implicit ev: Option[Boolean] => TypedExpression[Option[Boolean], TOptionBoolean]) =
    f.internalValue: TypedExpression[Option[Boolean], TOptionBoolean]

  implicit def enumFieldToTEF[A <: Enumeration#Value](f: Field[_, A])(implicit ev: A => TypedExpression[A, TEnumValue[A]]) =
    f.internalValue: TypedExpression[A, TEnumValue[A]]

  implicit def optionEnumFieldToTEF[A <: Enumeration#Value](f: OptionalField[_, A])(implicit ev: Option[A] => TypedExpression[A, TOptionEnumValue[A]]) =
    f.internalValue: TypedExpression[A, TOptionEnumValue[A]]

  implicit def byteFieldToTEF(f: Field[_, Byte])(implicit ev: Byte => TypedExpression[Byte, TByte]) =
    f.internalValue: TypedExpression[Byte, TByte]

  implicit def optionByteFieldToTEF(f: OptionalField[_, Byte])(implicit ev: Option[Byte] => TypedExpression[Option[Byte], TOptionByte]) =
    f.internalValue: TypedExpression[Option[Byte], TOptionByte]

  implicit def intFieldToTEF(f: Field[_, Int])(implicit ev: Int => TypedExpression[Int, TInt]) =
    f.internalValue: TypedExpression[Int, TInt]

  implicit def optionIntFieldToTEF(f: OptionalField[_, Int])(implicit ev: Option[Int] => TypedExpression[Option[Int], TOptionInt]) =
    f.internalValue: TypedExpression[Option[Int], TOptionInt]

  implicit def longFieldToTEF(f: Field[_, Long])(implicit ev: Long => TypedExpression[Long, TLong]) =
    f.internalValue: TypedExpression[Long, TLong]

  implicit def optionLongFieldToTEF(f: OptionalField[_, Long])(implicit ev: Option[Long] => TypedExpression[Option[Long], TOptionLong]) =
    f.internalValue: TypedExpression[Option[Long], TOptionLong]

  implicit def floatFieldToTEF(f: Field[_, Float])(implicit ev: Float => TypedExpression[Float, TFloat]) =
    f.internalValue: TypedExpression[Float, TFloat]

  implicit def optionFloatFieldToTEF(f: OptionalField[_, Float])(implicit ev: Option[Float] => TypedExpression[Option[Float], TOptionFloat]) =
    f.internalValue: TypedExpression[Option[Float], TOptionFloat]

  implicit def doubleFieldToTEF(f: Field[_, Double])(implicit ev: Double => TypedExpression[Double, TDouble]) =
    f.internalValue: TypedExpression[Double, TDouble]

  implicit def optionDoubleFieldToTEF(f: OptionalField[_, Double])(implicit ev: Option[Double] => TypedExpression[Option[Double], TOptionDouble]) =
    f.internalValue: TypedExpression[Option[Double], TOptionDouble]

  implicit def bigDecimalFieldToTEF(f: Field[_, BigDecimal])(implicit ev: BigDecimal => TypedExpression[BigDecimal, TBigDecimal]) =
    f.internalValue: TypedExpression[BigDecimal, TBigDecimal]

  implicit def optionBigDecimalFieldToTEF(f: OptionalField[_, BigDecimal])(implicit ev: Option[BigDecimal] => TypedExpression[Option[BigDecimal], TOptionBigDecimal]) =
